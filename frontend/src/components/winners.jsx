...
const Winners = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 to-purple-500 py-8">
            <h1 className="text-4xl font-bold text-green-50 flex items-center justify-center gap-3 mb-8">
